...
namespace Jade.Lecheng.Server.tool
{
    public static class KdApiSearch
    {
        //电商ID
        private static string EBusinessID = "1266615";
        //电商加密私钥，快递鸟提供，注意保管，不要泄漏
        private static string AppKey = "36bc0bee-00bc-4210-9a23-a857d9dc0ffe";
        //请求url
        ...
        public static string getOrderTracesByJson(string requestData)
        {
            ...
            string result = sendPost(ReqURL, param);//实际调用函数
