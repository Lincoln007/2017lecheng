...
namespace DBModel.Procurement
{
    ...
    public class ProcurementModel
    {
        ...
        public string express_codeE { get; set; }
    ...
    public class ProcurementModelE
    {
        ...
        public List<ProcurementModelEE> details { get; set; }

    }

    public class ProcurementModelEE
    {
