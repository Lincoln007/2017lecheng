...
{
   internal class MySqlQueryable<T> : ISugarQueryable<T>
    {
        ...
        public ISugarQueryable<TResult> Select<T2, T3, T4, T5, T6, TResult>(System.Linq.Expressions.Expression<Func<T, T2, T3, T4, T5, T6, TResult>> expression)
        {
            this.QueryableCore = ((Queryable<T>)this.QueryableCore).Select<T2, T3, T4, T5, T6, TResult>(expression);
            MySqlQueryable<TResult> reval = new MySqlQueryable<TResult>();
            reval.QueryableCore = this.QueryableCore;
            return reval;
        }

        public ISugarQueryable<TResult> Select<T2, T3, T4, T5, T6, T7, TResult>(System.Linq.Expressions.Expression<Func<T, T2, T3, T4, T5, T6,T7, TResult>> expression)
        {
            this.QueryableCore = ((Queryable<T>)this.QueryableCore).Select<T2, T3, T4, T5, T6,T7, TResult>(expression);
            MySqlQueryable<TResult> reval = new MySqlQueryable<TResult>();
            reval.QueryableCore = this.QueryableCore;
            return reval;
        }
        ...
        public ISugarQueryable<TResult> Select<T2, T3, T4, T5, T6, T7, T8, TResult>(System.Linq.Expressions.Expression<Func<T, T2, T3, T4, T5, T6, T7, T8, TResult>> expression)
        {
            this.QueryableCore = ((Queryable<T>)this.QueryableCore).Select<T2, T3, T4, T5, T6, T7, T8, TResult>(expression);
            MySqlQueryable<TResult> reval = new MySqlQueryable<TResult>();
            reval.QueryableCore = this.QueryableCore;
            return reval;
        }
