...
namespace SqlSugarRepository
{
    ...
    public class SugarDao
    {
        ...
        public static string ConnectionGloablString
        {
            get
            {
                string reval = "server=10.10.200.74;uid=sa;pwd=123!@#QAZ;database=DB_StarAsset_Global"; //这里可以动态根据cookies或session实现多库切换
                return reval;
            }
        }
        ...
        public static string ConnectionString
        {
            get
            {
                string reval = "server=1112.12.29.172;uid=sa;pwd=123!@#QAZ;database=Newlecheng"; //这里可以动态根据cookies或session实现多库切换
                return reval;
            }
        }
