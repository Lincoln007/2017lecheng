...
namespace SqlSugarRepository
{
    ...
    public class SugarDao
    {
        ...
        public static string ConnectionGloablString
        {
            get
            {
                string reval = "server=222.46.96.214;uid=sa;pwd=jhqn89808980;database=DB_Lehcneg_Global"; //这里可以动态根据cookies或session实现多库切换
                return reval;
            }
        }
        ...
        public static string ConnectionString
        {
            get
            {
                string reval = "server=222.46.96.214;uid=sa;pwd=jhqn89808980;database=20170717Newlecheng"; //这里可以动态根据cookies或session实现多库切换
                return reval;
            }
        }
