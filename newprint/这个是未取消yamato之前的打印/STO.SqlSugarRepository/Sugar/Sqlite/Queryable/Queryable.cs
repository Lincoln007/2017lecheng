...
namespace SQLiteSugar
{
    ...
    public class Queryable<T>
    {
        ...
        /// <param name="expression">给新实体赋值的表达式</param>
        /// <returns></returns>
        public Queryable<TResult> Select<T2, T3, T4, T5, T6, TResult>(Expression<Func<T, T2, T3, T4, T5, T6, TResult>> expression)
        {
            return this.Select<T, T2, T3, T4, T5, T6, TResult>(expression);
        }
        ...
        /// <returns></returns>
        public Queryable<TResult> Select<T2, T3, T4, T5, T6, T7, TResult>(Expression<Func<T, T2, T3, T4, T5, T6, T7, TResult>> expression)
        {
            return this.Select<T, T2, T3, T4, T5, T6, T7, TResult>(expression);
        }


        public Queryable<TResult> Select<T2, T3, T4, T5, T6, T7,T8, TResult>(Expression<Func<T, T2, T3, T4, T5, T6, T7, T8, TResult>> expression)
        {
            return this.Select<T, T2, T3, T4, T5, T6, T7, T8, TResult>(expression);
        }
